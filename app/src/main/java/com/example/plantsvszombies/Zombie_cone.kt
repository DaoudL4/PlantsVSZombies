...
class Zombie_cone(ligne: Int,  rayon : Float, listeCase : Array<Array<Case>>,  view: GameView, zombies: ArrayList<Zombie>, indice : Int) : Zombie(ligne, rayon, listeCase, view, zombies, indice) {
    override var pv = 300
